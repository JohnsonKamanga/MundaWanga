        ...
        <ScrollView className="flex-1 bg-[#a2af9f]">
          ...
          <View className="mt-5 mb-2 px-2">
            <Card className="p-[10px]">
              ...
              <View
                className="w-full flex flex-col p-3 rounded-md"
                style={{
                  borderWidth: 1,
                  borderColor: "rgba(34,139,34,0.3)",
                }}
              >
                ...
                <CardBody className="flex flex-row x-2 items-centre">
                  ...
                  <View
                    ...
                    className="p-3"
                  >
                    <Text className="text-gray-950">Desc :</Text>
                    <Text>Quantity:</Text>
                  </View>
                </CardBody>
              </View>
                  ...
                  <View className="flex flex-row gap-x-2 items-centre">
                    ...
                    >
                      <View className="flex flex-row gap-x-2 items-center">
                        ...
                        <CardHeader
                          content={
                            budgets.length > 0 ? budgets[0].name : "Budget"
                          }
                        />
                      </View>
                      <CardBody className="flex flex-row x-2 items-centre">
                        <Text className="text-[#228b22]">
                          Here is a summary on the Budget created on 12 November
                          2024.
                        </Text>
                          ...
                          {budgets.length > 0 ? (
                            <>
                              <Text className="text-gray-950">
                                Here is a summary that was created{" "}
                                {formatRelative(
                                  budgets[0].set_date,
                                  Date.now()
                                )}
                              ...
                              <ProgressBar
                                dividend={budgets[0].used}
                                divisor={budgets[0].max_amount}
                              />
                            </>
                          ) : (
                      ...
                      <CardFooter>
                        <Text className="text-[#228b22] font-bold">
                          Learn More
                        </Text>
                      </CardFooter>
                    </View>
